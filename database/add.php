<?php 
	...
	// Capture the table name from form ('users-add.php' =>'users', 'product-add.php' =>'products', 'supplier-add.php' =>'supplier')
	$table_name = $_SESSION['table'];

	// fetch columns of table in use where form records will be entered 
